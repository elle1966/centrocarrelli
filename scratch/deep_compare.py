...
def compare_nodes(node_b, node_r, path="body"):
    ...
    # If they are leaf nodes with just text, compare text directly
...
def main():
    ...
    print("Starting node-by-node body comparison...")
