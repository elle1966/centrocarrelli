...
if __name__ == '__main__':
    prods = extract_products(r'C:\Users\elly\.gemini\antigravity\brain\ef322864-b0b9-45c8-a2b6-ab68d82e01cc\.system_generated\steps\215\content.md')
    print(f"Extracted {len(prods)} unique products on Page 2:")
